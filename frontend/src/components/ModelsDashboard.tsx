...
export default function ModelsDashboard({
  ...
  return (
    <div className="flex-1 flex h-full text-zinc-100 overflow-hidden relative w-full bg-[#141414]" id="models-dashboard-main">
      ...
      >
              ...
              return (
                <div
                  ...
                  className={`w-full flex items-center justify-between px-2.5 py-2 rounded-lg text-left transition-all group ${
                    isSelected
                      ? 'bg-[#2b2b2b] text-zinc-100 border border-zinc-700/50 shadow-sm'
        ...
        {/* Add Platform Button */}
        <div className="p-3 border-t border-[#262626] bg-zinc-900/40">
          <button
            onClick={() => setShowAddProviderModal(true)}
            className="w-full py-1.5 border border-dashed border-zinc-800 hover:border-zinc-700 text-[11px] font-semibold text-zinc-400 hover:text-zinc-200 rounded-lg flex items-center justify-center space-x-1.5 transition-all bg-zinc-950/20 hover:bg-zinc-950/40 cursor-pointer"
          >
      ...
      {selectedProvider ? (
        <main className="flex-1 flex flex-col h-full overflow-hidden bg-[#1f1f1f]" id="models-right-workspace">
          {/* Header: Selected Provider title, switch toggle */}
          <div className="h-12 border-b border-[#2a2a2a] flex items-center justify-between px-5 bg-zinc-900/60 flex-shrink-0">
              ...
              <div className="flex items-center space-x-2">
                <div className="relative flex-1">
                  <input
                    ...
                    className="w-full bg-zinc-950/80 border border-zinc-800 focus:border-zinc-700 focus:outline-none rounded-md px-3 py-2 text-xs font-mono text-zinc-200"
                  />
                  <button
                    type="button"
                ...
                <button
                  ...
                  className="px-4 py-2 border border-zinc-800 hover:border-zinc-700 bg-zinc-900/60 hover:bg-zinc-850 text-[11px] font-semibold text-zinc-300 rounded-md transition-all flex items-center space-x-1.5 flex-shrink-0 cursor-pointer"
                >
                  {testingConnection ? (
                    <>
            ...
            <div className="space-y-1.5 pt-1">
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  onBlur={saveConnectionSettings}
                  className="flex-1 bg-zinc-950/80 border border-zinc-800 focus:border-zinc-700 focus:outline-none rounded-md px-3 py-2 text-xs font-mono text-zinc-200"
                />
                <button
                  onClick={handleResetUrl}
                  className="px-4 py-2 border border-zinc-800 hover:border-zinc-700 text-rose-500 hover:bg-rose-500/10 hover:border-rose-500/20 text-[11px] font-semibold bg-zinc-900/60 rounded-md transition-all flex-shrink-0 cursor-pointer"
                >
                  重置
                </button>
              </div>
        ...
        <main className="flex-1 flex flex-col h-full overflow-hidden bg-[#1f1f1f] items-center justify-center p-6 text-center text-zinc-500" id="models-right-workspace-empty">
            ...
            <form onSubmit={handleAddCustomProvider} className="space-y-4">
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 text-xs bg-zinc-950 border border-zinc-800 rounded-lg text-zinc-200 focus:outline-none focus:border-cyan-500"
                />
              </div>
              ...
              <div className="flex justify-end space-x-2 pt-2">
                <button
                  ...
                  className="px-3.5 py-1.5 text-xs text-zinc-400 hover:text-zinc-200 bg-zinc-900 hover:bg-zinc-850 rounded-lg border border-zinc-800 transition-all cursor-pointer"
                >
                  取消
                </button>
                <button
                  type="submit"
                  className="px-4 py-1.5 text-xs font-semibold text-zinc-950 bg-cyan-500 hover:bg-cyan-400 rounded-lg transition-all cursor-pointer shadow-md shadow-cyan-500/10"
                >
                  确认添加
                </button>
              </div>
